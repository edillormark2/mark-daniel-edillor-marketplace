    ...
    <div className="min-h-screen bg-gray-50">
      <div className="flex pt-16">
        ...
        <div className="flex-1 lg:ml-80">
          <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-4 py-2">
            {/* Header */}
            <div className="mb-8">
                  ...
                  <>
                    ...
                    <div className="mb-6 flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="hidden lg:flex items-center px-4 py-2 text-gray-600 hover:text-gray-900 transition-colors"
                      >
                        <span className="mr-2">Toggle Filters</span>
                      </button>
                    </div>
